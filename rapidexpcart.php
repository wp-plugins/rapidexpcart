	...
	<form action="" method="post" id="rapidexpcart-conf">
	  ...
	  <table>
		...
		<tr>
		  <th>
			<?php
				$lavel = str_replace( array( 'product/', 'product', 'cart', 'event' ),
									 array( '商品/', '<b>商品</b>', '<b>カート</b>', '<b>イベント</b>' ), $key );
		        echo $lavel;
			?>
	  ...
	  <table>
		...
		<tr><td><b>[rapidexpcart button=SKU]</b></td><td></td><td><b>SKU番号で指定されたカートボタン</b></td></tr>
